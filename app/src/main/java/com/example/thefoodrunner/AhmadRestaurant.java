...
public class AhmadRestaurant extends AppCompatActivity {
    Button btnAddBurger,btnAddPizza,btnAddShawarma,btnAddPlatter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ahmad_restaurant);
        getSupportActionBar().setTitle("Ahmad Restaurant");
        ...
        btnAddBurger.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(AhmadRestaurant.this,AddFood.class);
                startActivity(intent);
                Toast.makeText(AhmadRestaurant.this, "clicked!", Toast.LENGTH_SHORT).show();
            }
        });
